...
export const TECHS = [
  ...
  // ---- Konstruktion ---------------------------------------------------
  { id: "constr_titanium", discipline: "construction", level: 1, name: "Titanium Armor", effect: { type: "flavor" }, description: "Basispanzerung für alle Einheiten.", module: { kind: "armor", hpMultiplier: 1.0 } },
  ...
  { id: "constr_duralloy", discipline: "construction", level: 10, name: "Duralloy Armor", effect: { type: "flavor" }, description: "+50% Trefferpunkte für Schiffe, +Bodenkampfwert (ab v0.7).", module: { kind: "armor", hpMultiplier: 1.5 } },
  ...
  { id: "constr_zortium", discipline: "construction", level: 17, name: "Zortium Armor", effect: { type: "flavor" }, description: "+100% HP für Schiffe, +Bodenkampfwert (ab v0.7).", module: { kind: "armor", hpMultiplier: 2.0 } },
  ...
  { id: "constr_andrium", discipline: "construction", level: 26, name: "Andrium Armor", effect: { type: "flavor" }, description: "+150% HP für Schiffe, +Bodenkampfwert (ab v0.7).", module: { kind: "armor", hpMultiplier: 2.5 } },
  ...
  { id: "constr_tritanium", discipline: "construction", level: 33, name: "Tritanium Armor", effect: { type: "flavor" }, description: "+200% HP für Schiffe, +Bodenkampfwert (ab v0.7).", module: { kind: "armor", hpMultiplier: 3.0 } },
  ...
  { id: "constr_adamantium", discipline: "construction", level: 42, name: "Adamantium Armor", effect: { type: "flavor" }, description: "+250% HP für Schiffe, +Bodenkampfwert (ab v0.7).", module: { kind: "armor", hpMultiplier: 3.5 } },
  ...
  { id: "constr_neutronium", discipline: "construction", level: 50, name: "Neutronium Armor", effect: { type: "flavor" }, description: "+300% HP für Schiffe, ultimative Panzerung.", module: { kind: "armor", hpMultiplier: 4.0 } },
  ...
  { id: "prop_hydrogen", discipline: "propulsion", level: 2, name: "Hydrogen Fuel Cells", effect: { type: "flavor" }, description: "Flottenreichweite 4 Parsec (ab v0.4-Logistik-Feinschliff)." },
  { id: "prop_deuterium", discipline: "propulsion", level: 5, name: "Deuterium Fuel Cells", effect: { type: "flavor" }, description: "Flottenreichweite 5 Parsec (ab v0.4-Logistik-Feinschliff)." },
  ...
  { id: "prop_irridium", discipline: "propulsion", level: 9, name: "Irridium Fuel Cells", effect: { type: "flavor" }, description: "Flottenreichweite 6 Parsec (ab v0.4-Logistik-Feinschliff)." },
  ...
  { id: "prop_dotomite", discipline: "propulsion", level: 14, name: "Dotomite Crystals", effect: { type: "flavor" }, description: "Flottenreichweite 7 Parsec (ab v0.4-Logistik-Feinschliff)." },
  ...
  { id: "prop_uridium", discipline: "propulsion", level: 19, name: "Uridium Fuel Cells", effect: { type: "flavor" }, description: "Flottenreichweite 8 Parsec (ab v0.4-Logistik-Feinschliff)." },
  ...
  { id: "prop_reajax", discipline: "propulsion", level: 23, name: "Reajax II Fuel Cells", effect: { type: "flavor" }, description: "Flottenreichweite 9 Parsec (ab v0.4-Logistik-Feinschliff)." },
  ...
  { id: "prop_trilithium", discipline: "propulsion", level: 29, name: "Trilithium Crystals", effect: { type: "flavor" }, description: "Flottenreichweite 10 Parsec (ab v0.4-Logistik-Feinschliff)." },
  ...
  { id: "prop_thorium", discipline: "propulsion", level: 41, name: "Thorium Cells", effect: { type: "flavor" }, description: "Unbegrenzte Flottenreichweite (ab v0.4-Logistik-Feinschliff)." },
